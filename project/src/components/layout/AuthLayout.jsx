      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-navy-900 p-12 text-white lg:flex dark:bg-navy-950">
        ...
        <div className="relative flex items-center gap-2.5">
          ...
          <div className="leading-tight">
            <p className="text-sm font-bold">SurvitecXDahawi Brainstomers</p>
        ...
        <p className="relative text-xs text-white/40">© 2026 SurvitecXDahawi Brainstomers. Internal use only.</p>
      </div>
